...
from neuroacoustic_resonator import MetricsHistory, Simulation, SimulationConfig


def default_output_path(config_path: Path, steps: int, output_format: str) -> Path:
    return (
        Path("outputs")
        / "metrics"
...
def write_history(history: MetricsHistory, output_path: str | Path) -> Path:
...
def main(argv: list[str] | None = None) -> int:
    ...
    written_path = write_history(history, output_path)
