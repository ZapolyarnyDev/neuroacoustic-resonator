...
def default_output_path(output_format: OutputFormat) -> Path:
...
def write_results(results: list[BenchmarkResult], output_path: str | Path) -> Path:
...
def main(argv: list[str] | None = None) -> int:
    ...
    output_path = args.output or default_output_path(output_format)
    ...
    written_path = write_results(results, output_path)
