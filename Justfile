...
propagation-probe:
    uv run python scripts/probe_propagation.py --config configs/strict_propagation.yaml --warmup-steps 200 --horizon 2048 --impulse 0.45 --impulse-profile biphasic --response-threshold 0.000001 --seeds 67 101 211 --uncoupled-control --output-csv experiments/logs/propagation_probe.csv --output-summary experiments/logs/propagation_probe_summary.json --output-plot experiments/logs/propagation_probe.png
